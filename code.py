# -*- coding: utf-8 -*-
"""
Created on Thu Aug 20 11:54:10 2020
...
df2.isnull().sum()
#dropping the unwanted/NaN data's in the dataset 
df3 = df2.dropna()
...
locations_20cnt
#Now for particular cent location and availablity getting added
